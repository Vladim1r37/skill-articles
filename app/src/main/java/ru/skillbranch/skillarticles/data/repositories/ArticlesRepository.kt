...
object ArticlesRepository {
    ...
    fun searchArticles(searchQuery: String) =
        ArticlesDataFactory(ArticleStrategy.SearchArtcle(::searchArticlesByTitle, searchQuery))
    ...
    fun updateBookmark(id: String, isChecked: Boolean) {
        val articleItem = local.localArticleItems.first { it.id == id }
        val index = local.localArticleItems.indexOf(articleItem)
        local.localArticleItems[index] = articleItem.copy(isBookmark = !isChecked)
