...
class ArticleViewModel(private val articleId: String) : BaseViewModel<ArticleState>(ArticleState()) {
    ...
    fun handleOnSearch() {
        updateStateInBackground { it.copy(isSearch = true) }
    }

    fun handleOnCloseSearch(): Boolean {
        updateStateInBackground { it.copy(isSearch = false) }
        return false
    }

    fun handleSearchQuery(query: String?) {
        updateStateInBackground { it.copy(searchQuery = query) }
    }
